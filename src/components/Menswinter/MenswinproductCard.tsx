...
interface MenswinproductCardProps {
  id: number;
  name: string;
  price: number;
...
const MenswinproductCard = ({ id, name, price, originalPrice, image, badge }: MenswinproductCardProps) => {
  ...
  return (
    <Link to={`/menswinter/menswinterpd/${id}`}>
...
export default MenswinproductCard;
