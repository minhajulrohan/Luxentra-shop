...
const MensCategoryCard = ({ image, title, href, icon: Icon, bgColor = "bg-gradient-to-br from-primary/10 to-accent/10" }: CategoryCardProps) => {
  return (
    <a
      href={href}
...
export default MensCategoryCard;
